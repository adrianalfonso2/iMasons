    ...
    <div className="-mx-4 -my-8 px-4 py-12 min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden w-full">
          ...
          <div className="p-8">
            <h1 className="text-2xl font-bold text-brand-purple-dark mb-1">Create account</h1>
            <p className="text-brand-teal text-sm mb-6">Join the iMasons network</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Role selector */}
              <div>
                <label className="block text-sm font-medium text-brand-teal mb-2">I am a...</label>
                    ...
                    <button
                      ...
                      className={`py-2 px-4 rounded-xl border text-sm font-medium capitalize transition-colors ${
                        form.role === r
                          ...
                          : 'border-gray-200 text-gray-500 hover:border-brand-purple/40'
                      }`}
                    >
                      {r}
                    </button>
              ...
              {/* iMasons Identifier */}
              <div>
                <label className="block text-sm font-medium text-brand-teal mb-1">iMasons Identifier</label>
                <div className="relative">
                  {/* Key icon */}
                  <span className="absolute inset-y-0 left-3 flex items-center pointer-events-none text-brand-teal/60">
                  ...
                  <input
                    ...
                    required
                    className="w-full border border-gray-200 rounded-xl pl-9 pr-3 py-2.5 focus:ring-2 focus:ring-brand-purple focus:border-brand-purple outline-none transition-colors"
              ...
              {/* Confirm Password */}
              <div>
                <label className="block text-sm font-medium text-brand-teal mb-1">Confirm Password</label>
                <input
                  type="password"
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link to="/login" className="text-brand-purple font-semibold hover:text-brand-purple-dark transition-colors">
                Sign In
              </Link>
            </p>
          </div>
