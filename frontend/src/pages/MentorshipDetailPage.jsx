...
export default function MentorshipDetailPage() {
  ...
  const { data: job, loading } = useFetch(`/mentorships/${id}`);
  ...
  if (!job) return <div className="text-center py-12 text-gray-500">Mentorship not found</div>;
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <Link to="/mentorships" className="text-blue-600 hover:text-blue-800 text-sm mb-4 inline-block">
